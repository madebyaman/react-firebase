...
const reservations = [
  {
    id: '12345',
    restaurantId: '123',
    userId: 'lVZxwIUqceTGkVO3Qm0HuxRzBDQ2', // replace these userIds with your own
  ...
  },
  {
    id: '12346',
    restaurantId: '345',
    userId: 'lVZxwIUqceTGkVO3Qm0HuxRzBDQ2',
...
const reviews = [
  {
    ...
    photoUrls: [
      'https://storage.googleapis.com/reservation-fe876.appspot.com/reviewPhotos/hemingways-review-1.jpeg',
    ],
    text: `
...
const restaurants = [
  {
    ...
    name: "Hemingway's",
    imageUrl:
      'https://storage.googleapis.com/reservation-fe876.appspot.com/restaurants/hemingways.jpeg',
    rating: 4.0,
    address: {
  ...
  },
  {
    ...
    name: "Ben's Burgers",
    imageUrl:
      'https://storage.googleapis.com/reservation-fe876.appspot.com/restaurants/bens-burgers.jpeg',
    rating: 3.5,
    address: {
  ...
  },
  {
    ...
    name: 'Le Mollusc',
    imageUrl:
      'https://storage.googleapis.com/reservation-fe876.appspot.com/restaurants/le-mollusc.jpeg',
    rating: 4.5,
    address: {
